            ...
            if self.word_drop:
                ...
                if k is 'q':
                    ...
                    if k is 'located_sub_text':
                        ...
                        show = 'bbt' if get_show_name(cur_vid_name) is 'bbt' else ""
                        ...
                        vqa = self.trunc_if_gt_max_seq_len(vqa, self.max_seq_len)
                        items.append(self.numericalize(vqa))
...
def pad_collate(data):
    ...
    text_keys = ["q", "qm1", "qm2", "vqa0", "qa0", "vqa1", "qa1", "vqa2", "qa2", "vqa3", "qa3", "vqa4", "qa4", "sub",
                 "vcpt", "vcpt_ts", "vscene", "vscene_ts"]
    ...
    for i, k in enumerate(all_keys):
        if k in text_keys:
            ...
            if vfeat_type != 'conv':
                ...
                all_values.append(
                    pad_video_tensors(column_data[i]))  # appends padded videos, lengths, and binary masks for lengths
        else:
...
def preprocess_inputs(batched_data, max_sub_l, max_vcpt_l, max_vid_l, device="cuda:0"):
    ...
    max_len_dict = {"sub": max_sub_l, "vcpt": max_vcpt_l, "vcpt_ts": max_vcpt_l, "vid": max_vid_l}
    text_keys = ["q", "qm1", "qm2", "vqa0", "qa0", "vqa1", "qa1", "vqa2", "qa2", "vqa3", "qa3", "vqa4", "qa4", "sub",
                 "vcpt", "vcpt_ts", "vscene", "vscene_ts"]
    label_key = "answer_idx"
    bow_key = 'bow'
