...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--bsz", type=int, default=24, help="mini-batch size")
        self.parser.add_argument("--test_bsz", type=int, default=24, help="mini-batch size for testing")
        ...
        self.parser.add_argument("--wt2", type=float, default=0.0, help="weight hyperparameter for reasoning loss")
        ...
        self.parser.add_argument("--max_total_l", type=int, default=370, help="max length for video feature")
